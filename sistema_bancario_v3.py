...
class Historico:
    ...
    def adicionar_transacao(self, transacao):
        self._transacoes.append(
            {
                "tipo": transacao.__class__.__neme__,
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print("\nCliente não localizado! Criação de conta finalizada!")
        return
...
def main():
    ...
    while True:
        ...
        if opcao == "1":
            ...
            print("\nOperação inválida! Por favor, selecione corretamente a opção desejada.")
